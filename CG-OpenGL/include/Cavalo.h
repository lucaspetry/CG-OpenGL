...
private:
	...
	const double angulosCaminhada[NUMERO_MEMBROS][ESTAGIOS_CAMINHADA] = {
			...
			{ 2, -5, -16, -3, 33, 40 }, /* ANTEBRAÇO FRONTAL DIREITO */
			{ -5, 27, 35, 6, -2, -14 }, /* ANTEBRAÇO FRONTAL ESQUERDO */
			{ -27, -35, -33, -10, -5, -16 }, /* ANTEBRAÇO TRASEIRO DIREITO */
			{ -1, -11, -21, -30, -40, -35 }, /* ANTEBRAÇO TRASEIRO ESQUERDO */
