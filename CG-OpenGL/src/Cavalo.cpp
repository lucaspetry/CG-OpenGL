...
void Cavalo::desenharTronco(const int estagio, const bool caminhada) {
	...
	glutSolidSphere(1, 20, 20); // N�degas
	...
	gluCylinder(gluNewQuadric(), 0.7, 0.25, 2, 30, 30); // Pesco�o
	glTranslatef(0, 0, 2);
	...
	gluCylinder(gluNewQuadric(), 0.5, 0.18, 1.15, 30, 30); // Cabe�a
	glTranslatef(0, 0, 1.15);
	glScalef(0.18, 0.18, 0.18);
	glutSolidSphere(1, 20, 20); // Fu�o
	glPopMatrix();
